...
const basicTypeList = ['any', 'array', 'bool', 'element', 'elementType', 'func', 'node', 'number', 'object', 'string', 'symbol'];
const advancedTypeList = ['arrayOf', 'exact', 'instanceOf', 'objectOf', 'oneOf', 'oneOfType', 'shape'];

const toPropTyped = (propType, required = false, params = null) => {
  if (!propType.name) {
    return required ? PropTypes__default['default'][propType].isRequired : PropTypes__default['default'][propType];
  }

  if (required) {
    return PropTypes__default['default'][propType.name](params !== null && params !== void 0 ? params : propType.params).isRequired;
  }

  return PropTypes__default['default'][propType.name](params !== null && params !== void 0 ? params : propType.params);
};

function typed(component, types) {
  component.propTypes = {};
  ...
  for (let propType in types) {
    ...
    */
    ...
    switch (types[propType].type.name) {
      case 'arrayOf':
        {
          component.propTypes[propType] = PropTypes__default['default'].arrayOf(toPropTyped(types[propType].type.params));
          break;
        }

      case 'exact':
        {
          const propTypedParams = mapValues_1(types[propType].type.params, v => toPropTyped(v));
          component.propTypes[propType] = PropTypes__default['default'].exact(propTypedParams);
          break;
        }

      case 'instanceOf':
        {
          component.propTypes[propType] = PropTypes__default['default'].instanceOf(types[propType].type.params);
          break;
        }

      case 'objectOf':
        {
          component.propTypes[propType] = PropTypes__default['default'].objectOf(toPropTyped(types[propType].type.params));
          break;
        }

      case 'oneOf':
        {
          component.propTypes[propType] = PropTypes__default['default'].oneOf(types[propType].type.params);
          break;
        }
      ...
      case 'oneOfType':
        {
          ...
          component.propTypes[propType] = PropTypes__default['default'].oneOfType(propTypedParams);
          break;
        }
      ...
      case 'shape':
        {
          const propTypedParams = mapValues_1(types[propType].type.params, v => toPropTyped(v));
          component.propTypes[propType] = PropTypes__default['default'].shape(propTypedParams);
          break;
        }
    }
  }
