...
function Ne(e, n, r, o) {
  ...
  if (E(e)) {
    ...
    var u = e(n);
    return "production" !== process.env.NODE_ENV && typable_cjs.reactIs.isElement(u) && console.warn(b(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), Ne(u, n, r, o);
  }
...
var Ye = function (e) {
  return function e(t, r, o) {
    if (void 0 === o && (o = w), !typable_cjs.reactIs.isValidElementType(r)) return D(1, String(r));
